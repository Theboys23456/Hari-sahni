...
TOTAL_USER = os.environ.get('TOTAL_USERS', '7818565931, 8167879352, 6126688051').split(',')
TOTAL_USERS = [int(user_id) for user_id in TOTAL_USER]

AUTH_USER = os.environ.get('AUTH_USERS', '7818565931, 8167879352, 6126688051').split(',')
