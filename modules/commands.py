...
def register_commands_handlers(bot):
    ...
    async def cmd(client, callback_query):
        ...
        InputMediaPhoto(
          media="https://www.freepik.com/free-ai-image/portrait-anime-character-doing-fitness-exercising_236197782.htm#fromView=search&page=2&position=22&uuid=7aca9fb5-c87b-4cce-a2bd-8a697e666bc0&query=Hot+girl+cute+animated",
          caption=caption
        ),
...
# .....,.....,.......,...,.......,....., .....,.....,.......,...,.......,.....,
    ...
    async def help_button(client, callback_query):
      ...
      await callback_query.message.edit_media(
        InputMediaPhoto(
          media="https://www.freepik.com/premium-ai-image/stunning-digital-portrait-confident-female-with-expressive-blue-eyes-flowing-black-hair_292912268.htm#fromView=search&page=1&position=19&uuid=05f5aa6f-d09a-4578-9972-302056830492&query=Hot+girl+cute+animated",
          caption=caption
        ),
        reply_markup=keyboard
        )
